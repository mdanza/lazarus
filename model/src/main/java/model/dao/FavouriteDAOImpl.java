...
public class FavouriteDAOImpl implements FavouriteDAO {
	...
	public void add(Favourite favourite) {
		...
		if (favourite.getName() == null || favourite.getUser() == null
				|| favourite.getPoint() == null)
			throw new IllegalArgumentException(
					"name, user or point equals null");
	...
	public void delete(Favourite favourite) {
		if (favourite == null)
			throw new IllegalArgumentException("favourite is null");
		Favourite old = findByUserAndName(favourite.getUser(),
				favourite.getName());
		if (old == null)
	...
	public Favourite findByUserAndName(User user, String name) {
		...
		try {
			Query q = entityManager
					.createNamedQuery("Favourite.findByUserAndName");
